...
int xdp_redirect_func(struct xdp_md *ctx)
{
	...
	/* 1. Destination MAC: 왼쪽 방(left-env)의 주소 */
	/* 02:00:00:00:00:02 */
	unsigned char dst[ETH_ALEN] = {0x02, 0x00, 0x00, 0x00, 0x00, 0x02};
	
	/* 2. Source MAC: 라우터 왼쪽 인터페이스(eth0)의 주소 */
	/* 02:00:00:00:00:01 */
	unsigned char src[ETH_ALEN] = {0x02, 0x00, 0x00, 0x00, 0x00, 0x01};
